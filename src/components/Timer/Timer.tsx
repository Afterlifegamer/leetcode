...
const Timer: React.FC<TimerProps> = () => {
  ...
  return (
    <div>
      {showTimer ? (
        <div className="flex items-center space-x-2 bg-[hsla(0,0%,100%,.1)],py-1.5 cursor-pointer rounded hover:bg-[hsla(0,0%,100%,.14)]">
        ...
        <div
          className="flex items-center p-1 h-1 hover:bg-[hsla(0,0%,100%,.1)] rounded cursor-pointer"
